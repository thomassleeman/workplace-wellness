...
import { PhoneFrame } from '@/components/unused/PhoneFrame'
import {
  DiageoLogo,
  LaravelLogo,
  MirageLogo,
...
/* FEATURES COMPONENT (LARGE SCREENS) */
    ...
    >
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          <h2 className="text-grey-700 text-3xl font-medium tracking-tight">
            The Wellness Platform that focusses on mental health and avoiding
            burnout.
          </h2>
