      ...
      <div className="mx-auto max-w-7xl md:px-4 lg:px-6">
        <div className="mb-14">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            tellus eleifend orci egestas suscipit eget eu ante. Quisque eget
            venenatis turpis, ac vehicula enim. Aenean pretium pellentesque
            nibh, sit amet ultricies elit ultrices et. Suspendisse pulvinar
            turpis erat, ut posuere arcu viverra non.
          </p>
        </div>
